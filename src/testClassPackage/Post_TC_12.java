...
public class Post_TC_12 {
	public static void execute() throws IOException 
	{ 
		 for(int i=0;i<5;i++)
		 {
			 String baseURI=Post_Req_Repository.base_URI();
			 String requestBody=Post_Req_Repository.request_Body12();
			 ...
			 if(statusCode==201)
			 {
				 ...
				 Post_TC_12.validator(statusCode, requestBody, responseBody);
				 Utility_Common_Function .evidencefilecreater("Post_TC_12", requestBody, responseBody);
				 break;
			 }
			 else
			 {
